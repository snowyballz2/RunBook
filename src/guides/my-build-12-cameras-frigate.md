...
- **Push Notifications** → **off**: the web UI's **Surveillance → Push**, or app → **Device Settings → Push Notifications** — Reolink's push routes device → Reolink's servers → Apple → phone; Frigate and Home Assistant notifications replace it, local and far smarter
